...
This project includes [MoE-PEFT](https://github.com/TUDB-Labs/MoE-PEFT) as a submodule for reference. MoE-PEFT is an efficient LLM fine-tuning framework that provides production-ready implementations for Mixture of Expert (MoE) Parameter-Efficient Fine-Tuning, including MixLoRA.

To clone this repository with the MoE-PEFT submodule:

```bash
git clone --recurse-submodules https://github.com/uk00007/Mix-LoRA.git
```
